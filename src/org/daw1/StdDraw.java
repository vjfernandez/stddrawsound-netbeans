 ...
 *
 * @author Robert Sedgewick, tuneado por Victor para 1ºDAW
 * @version 15/Dic/2016
 *************************************************************************/
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    private static final double DEFAULT_XMAX = 512.0;
    private static final double DEFAULT_YMIN = 0.0;
    private static final double DEFAULT_YMAX = 512.0;
    private static double xmin, ymin, xmax, ymax;

    // for synchronization
    private static Object mouseLock = new Object();
    private static Object keyLock = new Object();
    private static boolean keyTreated = true;
    ...
    /**
     * Set the x-scale to be the default (between 0.0 and 512.0).
     */
    public static void setXScale() { setXScale(DEFAULT_XMIN, DEFAULT_XMAX); }

    /**
     * Set the y-scale to be the default (between 0.0 and 512.0).
     */
    ...
    /**
     * Set the pen size to the default (1{).
     */
    ...
    /**
     * Reads a string from a dialog box
    ...
    /**
     * Shows a question with a YES or NO response
     * @param message The message to show.
    ...
    public static boolean question(String message)   
    {
        boolean r;
        keyTreated=false;
        r = JOptionPane.showConfirmDialog(null, message, "", JOptionPane.YES_NO_OPTION)==0;
        keyTreated=true;
        return r;
    }    
